...
gmx editconf -f PET_single_malodour_ensemble.gro -o edited_conf.gro -c -bt triclinic -box 60 3 3
...
gmx grompp -f minim.mdp -c edited_conf.gro -p topol.top -o em.tpr
...
echo "2 0"|gmx trjconv -s npt.tpr -f npt.tpr -o npt_noPBC.trr -pbc mol -center
