...
gmx editconf -f PET.gro -o edited_conf.gro -c -bt cubic -box $box_len
...
gmx grompp -f prod_minim.mdp -c edited_conf.gro -p topol.top -o em.tpr
gmx mdrun -v -deffnm em -pin on -nt 6
